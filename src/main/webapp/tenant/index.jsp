...
<meta charset="utf-8">
   ...
   <!--  <link rel="icon" type="image/png" sizes="16x16" href="images/favicon.png"> -->
    <!-- Pignose Calender -->
    <link href="../template/tenant/plugins/pg-calendar/css/pignose.calendar.min.css" rel="stylesheet">
    <!-- Chartist -->
    <link rel="stylesheet" href="../template/tenant/plugins/chartist/css/chartist.min.css">
    <link rel="stylesheet" href="../template/tenant/plugins/chartist-plugin-tooltips/css/chartist-plugin-tooltip.css">
    <!-- Custom Stylesheet -->
...
<body>
    ...
    ***********************************-->
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="text-center">
                                    <img  src="https://icons.iconarchive.com/icons/paomedia/small-n-flat/256/house-icon.png" class="rounded-circle" alt="">
                                            ...
                                            <tbody>
                                                <tr>
                                                 <% for (int i = 0; i < boardingHouses.size(); i++) { %>
                                                    <td><img src="https://coffective.com/wp-content/uploads/2018/06/icon-house-blue.png" class=" rounded-circle mr-3" alt=""><%=boardingHouses.get(i).getName() %></td>
                                                    <td><%=boardingHouses.get(i).getAddress()%></td>
                                                    <td>
                                                        <span><%=boardingHouses.get(i).getElectricityUnitPrice() %></span>
                                                    </td>
                                                    <td>
                                                        <span><%=boardingHouses.get(i).getWaterUnitPrice() %></span>
                                                    </td>
                                                    <td> <a href="../tenant/room"><i class="fa fa-circle-o text-success  mr-2"></i> View Room </a></td>
                                                     <% } %> 
                                               </tr>
                                            </tbody>
                                        </table>
    ...
    <!-- Circle progress -->
    <script src="../template/tenant/plugins/circle-progress/circle-progress.min.js"></script>
    <!-- Datamap -->
    ...
    <script src="../template/tenant/plugins/pg-calendar/js/pignose.calendar.min.js"></script>
    <!-- ChartistJS -->
    <script src="../template/tenant/plugins/chartist/js/chartist.min.js"></script>
    <script src="../template/tenant/plugins/chartist-plugin-tooltips/js/chartist-plugin-tooltip.min.js"></script>
