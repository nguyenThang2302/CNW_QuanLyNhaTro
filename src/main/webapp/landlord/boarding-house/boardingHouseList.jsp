	...
	<div class="container">
		<div class="table-responsive">
			<div class="table-wrapper">
				<a href="../landlord/boarding-house/create.jsp"
					class="btn btn--radius-2 btn--red">Create new</a>
				<div class="table-title">
					<div class="row">
						<div class="col-sm-8">
							<h2>
								Boarding House <b>List</b>
							</h2>
						</div>
				...
				<table class="table table-striped table-hover table-bordered">
					...
					<tbody>
						...
						<tr>
							...
							<td><a
								href="../landlord/boarding-house?allroom=<%=boardingHouses.get(i).getId()%>"
				...
				<div class="clearfix">
					<div class="hint-text">
						Showing <b><%=boardingHouses.size()%></b> out of <b>20</b>
						entries
					</div>
					<ul class="pagination">
