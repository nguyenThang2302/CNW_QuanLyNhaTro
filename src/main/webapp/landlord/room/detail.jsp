...
<body>
	<%
	ArrayList<User> listUserInRoom = (ArrayList<User>) request.getAttribute("listUserInRoom");
	%>
	<div class="container">
			...
			<div class="table-wrapper">
				...
				<table class="table table-striped table-hover table-bordered">
					...
					<tbody>
						...
						<tr>
							<td><%=i + 1%></td>
							<td><%=listUserInRoom.get(i).getId()%></td>
							<td><%=listUserInRoom.get(i).getFullName()%></td>
							<td><%=listUserInRoom.get(i).getEmail()%></td>
							<td><%=listUserInRoom.get(i).getAddress()%></td>
						</tr>
						<%
						}
						%>
