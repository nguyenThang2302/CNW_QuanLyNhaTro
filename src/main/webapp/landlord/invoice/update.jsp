		...
		<div class="wrapper wrapper--w790">
			<div class="card card-5">
				<div class="card-heading">
					<h2 class="title">Cập nhật hoá đơn</h2>
				</div>
				<%
					...
					<form action="../landlord/boarding-house" method="POST">
						...
						<div class="form-row">
							...
							<div class="value">
								<div class="input-group">
									<input class="input--style-5" type="number"
										name="currentElectricMeter" value=<%=invoice.getCurrentElectricMeter() %>>
								</div>
							</div>
						</div>
						<div class="form-row">
							...
							<div class="value">
								<div class="input-group">
									<input class="input--style-5" type="number"
										name="currentWaterMeter" value=<%=invoice.getCurrentWaterMeter() %>>
								</div>
							</div>
						</div>
						...
						<div>
							<button class="btn btn--radius-2 btn--red" type="submit"
								name="updateInvoice">Cập nhật hoá đơn</button>
						</div>
					</form>
				</div>
			</div>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$(document).ready(function() {
				...
				var idbdhParam = url.searchParams.get("update_invoice");
