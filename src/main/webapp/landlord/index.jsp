...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="../landlord/boarding-house">
                    <i class="fas fa-fw fa-tachometer-alt"></i>
                    <span>Boarding House</span></a>
            </li>
            ...
            <!-- Nav Item - Tables -->
            <li class="nav-item">
                <a class="nav-link" href="../landlord/boarding-house?view_invoice=true">
    ...
    <!-- Page level plugins -->
    <script src="../template/index/vendor/chart.js/Chart.min.js"></script>

    <!-- Page level custom scripts -->
    <script src="../template/index/js/demo/chart-area-demo.js"></script>
    <script src="../template/index/js/demo/chart-pie-demo.js"></script>
