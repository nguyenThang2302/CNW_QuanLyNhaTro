				...
				<ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow" href="javascript:void()"
						...
						<ul aria-expanded="false">
							<li><a href="./list_landlord">Landlord</a></li>
							<li><a href="./list_tenant">Tenant</a></li>
						</ul></li>
								...
								<div class="table-responsive">
									<table class="table table-responsive-sm">
										...
										<tbody>
											...
											%>
											<tr>
												<th><%=users.get(i).getId()%></th>
												<td><%=users.get(i).getFullName()%></td>
												<td><%=users.get(i).getEmail()%></td>
												<td class="color-danger"><%=users.get(i).getAddress()%></td>
												<td><span class="badge badge-success form-select"><%=users.get(i).getRole()%></span></td>
