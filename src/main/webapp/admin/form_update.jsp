				...
				<ul class="metismenu" id="menu">
					...
					<li><a class="has-arrow" href="javascript:void()"
						...
						<ul aria-expanded="false">
							<li><a href="../template/admin/list_landlord">Landlord</a></li>
							<li><a href="../template/admin/list_tenant">Tenant</a></li>
						</ul></li>
							...
							<div class="card-body">
								<div class="basic-form">
									...
									<form class="user" action="update?email=<%=userInfo.getEmail()%>"
										...
										<div class="form-group row">
											<div class="col-sm-6 mb-3 mb-sm-0">
												<select class="form-control form-control-user" id="enabled"
													name="isEnabled">
										...
										<button type="submit"
											class="btn btn-primary btn-user btn-block mx-auto">Update</button>
										<hr>
